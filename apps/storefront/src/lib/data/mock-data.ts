...
export const DEMO_FARMER_ACCOUNT = {
  ...
  addresses: [
    {
      id: "addr_mandya_farm_01",
      customer_id: "cus_demo_basavaraj",
      first_name: "Basavaraj",
      last_name: "Patil",
      company: "Patil Organic Farms",
      address_1: "Sy No. 42/1, Sugar Factory Road",
      address_2: "Near Maddur Railway Gate",
      city: "Maddur",
      country_code: "in",
      province: "Karnataka",
      postal_code: "571401",
      ...
      metadata: {
        taluk: "Maddur",
        district: "Mandya",
        landmark: "Next to BioTill Agri Depot",
      },
    },
  ],
  metadata: {
    ...
    primary_crops: "Sugarcane, Paddy, Vegetables",
    district: "Mandya",
    taluk: "Maddur",
    soil_type: "Red Loamy Soil",
    irrigation_source: "Canal & Borewell",
    kisan_card_status: "Verified Kisan Card",
    member_tier: "BioTill Gold Member",
    kannada_name: "ಬಸವರಾಜ ಪಾಟೀಲ",
  },
}
