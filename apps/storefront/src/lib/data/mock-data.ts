...
export const DEMO_ORDERS: HttpTypes.StoreOrder[] = [
  {
    id: "order_bt_live_984210",
    display_id: 984210,
    status: "in_transit" as unknown as HttpTypes.StoreOrderStatus,
    fulfillment_status: "shipped" as unknown as HttpTypes.StoreOrderFulfillmentStatus,
    payment_status: "captured" as unknown as HttpTypes.StoreOrderPaymentStatus,
    currency_code: "inr",
    ...
    items: [
      {
        ...
        subtitle: "1 Kg Pack - Bio-Fungicide",
        quantity: 2,
        unit_price: 150,
        thumbnail: "/images/products/trichoderma-harzianum.png",
        product_id: "prod_tricho_harzianum",
        product_title: "Trichoderma Harzianum (ಟ್ರೈಕೋಡರ್ಮಾ ಹಾರ್ಜಿಯಾನಂ)",
        variant_id: "var_tricho_1",
        variant_title: "1 Kg Powder Pack",
      } as unknown as HttpTypes.StoreOrderLineItem,
      {
        id: "item_npk_1",
        title: "Liquid Bio NPK Consortia (ಲಿಕ್ವಿಡ್ ಎನ್.ಪಿ.ಕೆ ಕನ್ಸಾರ್ಸಿಯಂ)",
        subtitle: "1 Litre Canister - N, P & K Fixing Bacteria",
        quantity: 1,
        unit_price: 350,
        thumbnail: "/images/products/liquid-consortium.png",
        product_id: "prod_liquid_consortium",
        product_title: "Liquid Bio NPK Consortia (ಲಿಕ್ವಿಡ್ ಎನ್.ಪಿ.ಕೆ ಕನ್ಸಾರ್ಸಿಯಂ)",
        variant_id: "var_liquid_npk_1",
        variant_title: "1 Litre Liquid Canister",
      } as unknown as HttpTypes.StoreOrderLineItem,
    ],
    subtotal: 650,
    shipping_total: 0,
    ...
    shipping_address: {
      ...
      last_name: "Patil",
      company: "Patil Sugarcane Farm (ಪಾಟೀಲ ಕೃಷಿ ಫಾರ್ಮ್)",
      address_1: "Sy No. 42/1, Sugar Factory Road, Maddur Taluk",
      address_2: "Near Maddur Dairy, Mandya",
      city: "Mandya",
      province: "Karnataka",
      postal_code: "571428",
      country_code: "in",
    ...
    billing_address: {
      ...
      first_name: "Basavaraj",
      last_name: "Patil",
      company: "Patil Sugarcane Farm",
      address_1: "Sy No. 42/1, Sugar Factory Road, Maddur Taluk",
      address_2: "Mandya District",
      city: "Mandya",
      province: "Karnataka",
      postal_code: "571428",
      country_code: "in",
    ...
    shipping_methods: [
      {
        id: "sm_kisan_express",
        name: "Kisan Rural Express (ಉಚಿತ ಕೃಷಿ ಎಕ್ಸ್‌ಪ್ರೆಸ್ ವಿತರಣೆ)",
        amount: 0,
      } as unknown as HttpTypes.StoreOrderShippingMethod,
    ],
    payment_collections: [
      {
        id: "paycol_phonepe_live",
        status: "authorized",
        payments: [
          {
            id: "pay_phonepe_984210",
            provider_id: "pp_upi_phonepe",
            amount: 650,
            currency_code: "inr",
          },
        ],
    ...
    metadata: {
      tracking_number: "KA-EXP-984210",
      courier_partner: "Mandya Krishi Rural Logistics (ಮಂಡ್ಯ ಕೃಷಿ ಎಕ್ಸ್‌ಪ್ರೆಸ್)",
      tracking_url: "/in/account/orders",
      delivery_otp: "5421",
      estimated_delivery: "Today by 5:30 PM (ಇಂದು ಸಂಜೆ)",
      tracking_steps: [
        { title: "Order Placed & Payment Verified (PhonePe UPI)", time: "Yesterday, 4:15 PM", completed: true },
        { title: "BioTill Agri Depot QC Passed (ಬಯೋಟೀಲ್ ಗುಣಮಟ್ಟ ತಪಾಸಣೆ)", time: "Yesterday, 6:30 PM", completed: true },
        { title: "Dispatched from Mandya Central Hub (ರವಾನಿಸಲಾಗಿದೆ)", time: "Today, 7:00 AM", completed: true },
        { title: "Out for Farm Delivery to Maddur Village (ವಿತರಣೆಗೆ ಹೊರಟಿದೆ)", time: "Today, 11:30 AM", completed: true, active: true },
        { title: "Farm Gate Handover (ರೈತರ ಕೈಸೇರಲಿದೆ)", time: "Est. 5:30 PM", completed: false },
      ],
    },
  },
  {
    ...
    display_id: 982104,
    status: "completed" as unknown as HttpTypes.StoreOrderStatus,
    fulfillment_status: "delivered" as unknown as HttpTypes.StoreOrderFulfillmentStatus,
    payment_status: "captured" as unknown as HttpTypes.StoreOrderPaymentStatus,
    currency_code: "inr",
    email: "basavaraj.patil@biotill.farmer",
    ...
    items: [
      {
        id: "item_vam_1",
        title: "BioTill VAM Mycorrhizae (ಮೈಕೋರೈಜಾ ಜೈವಿಕ ಗೊಬ್ಬರ)",
        subtitle: "5 Kg Granules - Root Inoculant",
        quantity: 1,
        unit_price: 600,
        thumbnail: "/images/products/vam-mycorrhizae.png",
        product_id: "prod_vam_mycorrhizae",
        product_title: "BioTill VAM Mycorrhizae (ಮೈಕೋರೈಜಾ ಜೈವಿಕ ಗೊಬ್ಬರ)",
        variant_id: "var_vam_1",
        variant_title: "5 Kg Granules Bucket",
      } as unknown as HttpTypes.StoreOrderLineItem,
      {
        id: "item_pseudo_1",
        title: "Pseudomonas Fluorescens (ಸ್ಯೂಡೋಮೊನಾಸ್ ಫ್ಲೋರೆಸೆನ್ಸ್)",
        subtitle: "1 Litre - Liquid Protectant",
        quantity: 2,
        unit_price: 350,
        thumbnail: "/images/products/pseudomonas-fluorescens.png",
        product_id: "prod_pseudo_fluorescens",
        product_title: "Pseudomonas Fluorescens (ಸ್ಯೂಡೋಮೊನಾಸ್ ಫ್ಲೋರೆಸೆನ್ಸ್)",
        variant_id: "var_pseudo_1",
        variant_title: "1 Litre Liquid",
      } as unknown as HttpTypes.StoreOrderLineItem,
    ],
    subtotal: 1300,
    shipping_total: 0,
    ...
    shipping_address: {
      ...
      first_name: "Basavaraj",
      last_name: "Patil",
      company: "Patil Organic Farm",
      address_1: "Sy No. 42/1, Sugar Factory Road, Maddur",
      city: "Mandya",
      province: "Karnataka",
      postal_code: "571428",
      country_code: "in",
    ...
    billing_address: {
      ...
      first_name: "Basavaraj",
      last_name: "Patil",
      address_1: "Sy No. 42/1, Sugar Factory Road",
      city: "Mandya",
      province: "Karnataka",
      postal_code: "571428",
      country_code: "in",
    ...
    metadata: {
      tracking_number: "KA-EXP-982104",
      courier_partner: "India Post Agri Express (ಭಾರತೀಯ ಅಂಚೆ ಕೃಷಿ ಸೇವೆ)",
      delivered_on: new Date(Date.now() - 3 * 24 * 3600 * 1000).toDateString(),
      signed_by: "Basavaraj Patil (ಸ್ವೀಕರಿಸಲಾಗಿದೆ)",
    },
  },
]
...
export const DEMO_FARMER_ACCOUNT = {
  ...
  first_name: "Basavaraj",
  last_name: "Patil",
  email: "basavaraj.mandya@biotill.farmer",
  phone: "9845012345",
  has_account: true,
  ...
  metadata: {
    ...
    farm_size_acres: "5 Acres (Sugarcane & Paddy)",
    landholding_acres: "5 Acres",
