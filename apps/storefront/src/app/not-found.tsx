  ...
  return (
    <div className="flex flex-col gap-4 items-center justify-center min-h-[calc(100vh-80px)] p-6 text-center bg-emerald-50/30">
      ...
      <p className="text-base text-slate-600 max-w-md">
        The agri-biotech product or page you requested could not be located. Explore certified bio-fertilizers, biopesticides, and crop stimulants in our catalog.
      </p>
      <Link
        href="/in"
